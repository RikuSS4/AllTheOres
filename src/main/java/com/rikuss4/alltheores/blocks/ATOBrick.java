...
public class ATOBrick extends Block {
	...
	public ATOBrick(String name, ATOOre ore, int color, int renderType, int burnTime) {
		super(Material.iron);
		...
		setOre(ore);
		setOreDictName("brick" + getFullname().replaceAll(" ", ""));
