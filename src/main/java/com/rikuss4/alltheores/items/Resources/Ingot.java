...
public class Ingot extends Item {
	...
	public String getItemStackDisplayName(ItemStack itemStack) {
		if (getOre() != null) {
			...
			return (StatCollector.translateToLocal("AllTheOres." + getType().toLowerCase() + "Substite")).replaceFirst("ORENAME", name);
		} else {
			return "?";
		}
	}
	...
	public void registerIcons(IIconRegister iconRegister) {
		if (iconRegister instanceof TextureMap) {
			...
			if (texture == null) {
				texture = new ItemTexture(this.getOre(), name, getColor(), getRenderType(), "ingot");
