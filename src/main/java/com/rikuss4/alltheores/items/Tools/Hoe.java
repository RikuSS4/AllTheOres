...
public class Hoe extends ItemHoe {
	...
	public Hoe(String unlocalizedName, ToolMaterial material, ATOOre ore, int color, int renderType) {
		super(material);
		this.setName(unlocalizedName + "_hoe");
		this.setOre(ore);
		this.setColor(color);
	...
	public String getItemStackDisplayName(ItemStack itemStack) {
		...
		return (StatCollector.translateToLocal("AllTheOres.hoeSubstite")).replaceFirst("ORENAME", name);
	}
	...
	public void registerIcons(IIconRegister iconRegister) {
		if (iconRegister instanceof TextureMap) {
			...
			if (texture == null) {
				texture = new ItemTexture(this.getOre(), name, getColor(), getRenderType(), "hoe");
