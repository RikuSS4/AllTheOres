...
public class Pickaxe extends ItemPickaxe {
	...
	public Pickaxe(String unlocalizedName, ToolMaterial material, ATOOre ore, int color, int renderType) {
		super(material);
		this.setName(unlocalizedName + "_pickaxe");
		this.setOre(ore);
		this.setColor(color);
	...
	public String getItemStackDisplayName(ItemStack itemStack) {
		...
		return (StatCollector.translateToLocal("AllTheOres.pickaxeSubstite")).replaceFirst("ORENAME", name);
	}
	...
	public void registerIcons(IIconRegister iconRegister) {
		if (iconRegister instanceof TextureMap) {
			...
			if (texture == null) {
				texture = new ItemTexture(this.getOre(), name, getColor(), getRenderType(), "pickaxe");
