package com.rikuss4.alltheores.items.Weapons;
...
public class Sword extends ItemSword {
	...
	public Sword(String unlocalizedName, ToolMaterial material, ATOOre ore, int color, int renderType) {
		super(material);
		this.setName(unlocalizedName + "_sword");
		this.setOre(ore);
		this.setColor(color);
	...
	public String getItemStackDisplayName(ItemStack itemStack) {
		...
		return (StatCollector.translateToLocal("AllTheOres.swordSubstite")).replaceFirst("ORENAME", name);
	}
	...
	public void registerIcons(IIconRegister iconRegister) {
		if (iconRegister instanceof TextureMap) {
			...
			if (texture == null) {
				texture = new ItemTexture(this.getOre(), name, getColor(), getRenderType(), "sword");
